...
// exists for the same reason: `rules/stealth.ts` and `rules/hide.ts` must not learn a feat name or a DC.
 ...
 *
 * The mirror of `bonusDashSource`, and needed for the same reason: `rules/hide.ts` is the only way most of
