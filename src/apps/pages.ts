  ...
  sections: [
    {
      ...
      rows: [
        ...
        {
          id: "sheetPace",
          label: "NOODLRHOOKS.General.SheetPace.Name",
          hint: "NOODLRHOOKS.General.SheetPace.Hint",
          state: "live",
          setting: G.sheetPace,
          kind: "boolean",
          ownership: "sheetPace",
        ...
        {
          id: "modeTraverse",
          label: "NOODLRHOOKS.General.ModeTraverse.Name",
          hint: "NOODLRHOOKS.General.ModeTraverse.Hint",
          state: "live",
          setting: G.modeTraverse,
          kind: "boolean",
          ownership: "modeTraverse",
        },
        {
          id: "transformLoot",
...
const SHARED_ROLLS: Section = {
  ...
  rows: [
    ...
    {
      id: "owedSecondsGm",
      label: "NOODLRHOOKS.Combat.OwedSeconds.Gm.Name",
      hint: "NOODLRHOOKS.Combat.OwedSeconds.Gm.Hint",
      state: "live",
      setting: C.owedSecondsGm,
      kind: "number",
      range: { min: 0, max: 120, step: 1 },
    },
    {
      id: "owedSecondsPlayers",
      label: "NOODLRHOOKS.Combat.OwedSeconds.Players.Name",
      hint: "NOODLRHOOKS.Combat.OwedSeconds.Players.Hint",
      state: "live",
      setting: C.owedSecondsPlayers,
      kind: "number",
      range: { min: 0, max: 120, step: 1 },
    },
    {
