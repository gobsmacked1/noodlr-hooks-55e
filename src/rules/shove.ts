...
import { actionFor, readLocomotion } from "../core/locomotion";
import { cornerFor } from "../core/movement";
import { hazardsUnder } from "../core/hazards";
import { blocked, centerOf, insideScene, occupied, type Point } from "../core/positioning";
import type { Shift } from "../system/dnd5e-forced-movement";
